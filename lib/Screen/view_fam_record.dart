...
class ViewFamRecord extends StatefulWidget {
  const ViewFamRecord({Key? key}) : super(key: key);

  @override
  _ViewFamRecordState createState() => _ViewFamRecordState();
}

class _ViewFamRecordState extends State<ViewFamRecord> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("View Family Member BP Record"),
