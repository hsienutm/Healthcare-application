...
class AddAppointmentInCalendar extends StatefulWidget {
  const AddAppointmentInCalendar({Key? key}) : super(key: key);

  @override
  _AddAppointmentInCalendarState createState() =>
      _AddAppointmentInCalendarState();
}

class _AddAppointmentInCalendarState extends State<AddAppointmentInCalendar> {
                ...
                DatePicker.showTimePicker(context, showTitleActions: true,
                  ...
                  setState(() {
                    ...
                    if (startDateTimeString != "") {
                      startDateTimeString += " " + _timeController.text;
                    } else {
                      startDateTimeString = DateFormat('yyyy-MM-dd')
                              .format(selectedDate!)
                              .toString() +
                          " " +
                          _timeController.text;
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                FirebaseFirestore.instance
                    ...
                    .add({
                  'start_date':
                      Timestamp.fromDate(DateTime.parse(startDateTimeString)),
                  'end_date':
